...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zy0eoxa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zy0eoxa.containers.anotherwebservice.com/
...
```
git clone git@github.com:aaduo01/container-zy0eoxa.git
cd container-zy0eoxa
```
...
```
docker attach container-zy0eoxa
```
